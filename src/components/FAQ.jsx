...
export default function FAQ({id}) {
    return (
        <div className="mt-10 flex flex-col items-center justify-center" id={id}>
            ...
            <Accordion className="m-4" question="Where will this event take place?" answer="Friday’s workshops as well as hacking on Saturday and Sunday will be at the Central Campus Classroom Building (CCCB) at 1225 Geddes Ave, Ann Arbor, MI 48109." />
