...
export default function About({id}) {
    return (
        <div id={id} >
            ...
            <br/> <br/>
            Participants will get <span className="font-bold">access</span> to <span className="font-bold"> Gemini 1.5 API</span> along with a host of other 
            Google AI Studio tools. Assorted tech talks and workshops accompany a few speakers you <span className="italic"> don't</span> want to miss. Of course, hackathon swag will be plentiful, 
