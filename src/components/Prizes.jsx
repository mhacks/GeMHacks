        ...
        <div className="flex flex-col items-center justify-center">
            ...
            <div class="p-10 w-64 h-64 border-black border-2 rounded-md shadow-[8px_8px_0px_rgba(0,0,0,1)] bg-white">
                <div class="flex flex-col items-center justify-center h-full">
                    ...
                    <h1 class="text-4xl font-syncopate font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-500 to-purple-600 animated-gradient">$1500</h1>
                </div>
            </div>
